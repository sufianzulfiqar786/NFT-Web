...
// video
import SummonVideo from "../../assets/images/home/Summon.mp4";
...
const Summon = () => {
    ...
    return (
        <div className="relative">
            ...
            <video autoPlay muted loop src={SummonVideo}
                className={`w-full ${videoLoaded ? '' : 'hidden'}`}
                onLoadedData={() => setVideoLoaded(true)} />
            <div className="summon-bg absolute w-full w-full h-full top-[0%] flex justify-center items-center flex-col ">
                <p className='gradient-outline-brown-light mt-[43%] text-center text-[4vw] md:text-[5vw] font-upheaval hover:text-[white] tracking-[3px] leading-[28px] md:leading-[60px] 2xl:leading-[80%] transition ease-in-out duration-500'>
