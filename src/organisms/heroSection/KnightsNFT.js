...
// video
import NFTPage from "../../assets/images/home/NFTPage.mp4";
...
const HeroSectionKnightsNFT = () => {
    ...
    return (
        <div className="relative">
            ...
            <video autoPlay muted loop src={NFTPage}
                className={`w-full ${videoLoaded ? '' : 'hidden'}`}
                onLoadedData={() => setVideoLoaded(true)} />
            {videoLoaded && <>
                <div className="nft-page-bg absolute w-full w-full h-full top-[0%] flex justify-center items-center flex-col ">
                    ...
                    <div className="flex flex-wrap justify-center  items-center md:flex-row  border hover:border-2 border-[#00000000] font-['VT323'] text-[1em] sm:text-[2.3em] xl:text-[32px] 2xl:text-[3vw] rounded-xl w-[100%]  lg:w-[100%] mt-2 md:mt-12">
                        {
                            knightsNFTData.map(({ text1, text2, id }) => <button key={id} className='knights-nft-btn font-upheaval  h-[35%] sm:h-[108px] 2xl:h-[230px] w-[40%] lg:w-[20%] mx-2 mt-4 lg:mt-0 pb-4 2xl:pb-[1.5%]'>
