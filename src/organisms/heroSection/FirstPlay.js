...
// video
import AnimPlayGame from "../../assets/images/home/AnimPlayGame.mp4";
...
const HeroFirstPlay = () => {
    ...
    return (
        <div className="relative  ">
            ...
            <video autoPlay muted loop src={AnimPlayGame}
            ...
            {videoLoaded && <div className="first-play-bg absolute w-full h-full top-[0%] flex justify-center items-center flex-col ">
                ...
                <div className="flex justify-center border hover:border-2 border-[#00000000] text-white hover:text-[#fe9710] bg-[#00000077] hover:bg-[#000000af] w-[76%] lg:w-[40%] mt-2 md:mt-12 transition ease-in-out duration-1000">
                ...
                <div className="flex justify-center border hover:border-2 border-[#00000000] text-white hover:text-[#fe9710] bg-[#00000077] hover:bg-[#000000af] w-[46%] lg:w-[40%] 2xl:w-[30%] mt-2 md:mt-12 transition ease-in-out duration-1000">
